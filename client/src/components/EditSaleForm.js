...
const EditSaleForm = ({ saleInfo, updateSaleForm, createSale, history, userId, sale }) => {
...
const mapStateToProps = state => {
 ...
 export default connect(mapStateToProps, { updateSaleForm, createSale })(EditSaleForm);
